...
pathResults1 <- file.path(path, "results\\vsnNorm\\outlierRM2\\GFAP+ outlier removal after filter\\")
...
GFAP_res <- read.csv(paste0(pathResults1, "sig_res_EBayes_adjusted_MS_vs_Ctrl_strict.csv"))  
